...
async def spotify_callback():
    ...
    print("SPOTIFY: " + email, spotify_id, access_token)
    await link_spotify(email, spotify_id, access_token)
    ...
    return redirect(f"http://localhost:5500/project/backend/profile.html?token={jwt_token}")
